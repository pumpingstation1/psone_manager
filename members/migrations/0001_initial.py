...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('members_userprofile', (
            ...
            ('paypal_email', self.gf('django.db.models.fields.EmailField')(max_length=75, blank=True)),
            ('paypal_id', self.gf('django.db.models.fields.CharField')(max_length=13, blank=True)),
            ('member_since', self.gf('django.db.models.fields.DateField')(blank=True)),
            ('member_until', self.gf('django.db.models.fields.DateField')(blank=True)),
        ))
    ...
    models = {
        ...
        'members.userprofile': {
            ...
            'member_since': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
            'member_until': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
